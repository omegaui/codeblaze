...
//		}
	...
	public void init(){
		...
		closeComp = new TextComp("x", secondaryColorShade, warningColorShade, warningColor, this::closeTab);
...
//		}
	...
	public void paint(Graphics graphics){
		...
		if(focussed)
			g.setPaint(new GradientPaint(0, 0, isDarkMode() ? tertiaryColor : primaryColor, getWidth(), getHeight(), isDarkMode() ? tertiaryColor : secondaryColor));
		else
